...
// ── DOMMatrix polyfill for Vercel / Node.js serverless ────────────────────────
// pdfjs-dist references DOMMatrix at module initialisation.
// Node.js does not expose it; we provide a minimal stub so text extraction works.
if (typeof globalThis.DOMMatrix === "undefined") {
    ...
    (globalThis as any).DOMMatrix = class DOMMatrix {
        ...
        multiply(_m: unknown) { return new (globalThis as any).DOMMatrix(); }
        translate(_tx = 0, _ty = 0, _tz = 0) { return new (globalThis as any).DOMMatrix(); }
        scale(_sx = 1, _sy = 1, _sz = 1) { return new (globalThis as any).DOMMatrix(); }
...
// Polyfill Path2D (also used by pdfjs-dist canvas paths in Node.js)
